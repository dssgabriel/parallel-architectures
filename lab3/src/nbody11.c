                    ...
                    f32 *softening, f32 *dt, u64 n)
{
    ...
    __m512 fx, fy, fz;
    __m512 dx, dy, dz;
    __m512 d_2, d_2xy, d_2zs, d_2_sqrt, d_3_over_2;
    __m512 tmp_3x, tmp_3y, tmp_3z;
    __m512 vsoft, vdt;
    ...
    d_2_sqrt = _mm512_setzero_ps();
    d_3_over_2 = _mm512_setzero_ps();

    tmp_3x = _mm512_setzero_ps();
    tmp_3y = _mm512_setzero_ps();
    tmp_3z = _mm512_setzero_ps();
    ...
    for (u64 i = 0; i < n; i++) {
		...
		for (u64 j = 0; j < n; j += 8) {
            ...
            d_2_sqrt = _mm512_sqrt_ps(d_2);
            d_3_over_2 = _mm512_mul_ps(d_2_sqrt, d_2_sqrt);
            d_3_over_2 = _mm512_mul_ps(d_3_over_2, d_2_sqrt);

            tmp_3x = _mm512_div_ps(dx, d_3_over_2);
            tmp_3y = _mm512_div_ps(dy, d_3_over_2);
            tmp_3z = _mm512_div_ps(dz, d_3_over_2);

            fx = _mm512_add_ps(fx, tmp_3x);
            fy = _mm512_add_ps(fy, tmp_3y);
            fz = _mm512_add_ps(fz, tmp_3z);
		}
